	...
	var Greeter = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'div',
				null,
				React.createElement(GreeterMessage, { name1: 'bilbob', name2: name2.fname, name3: name3, msg: text3 }),
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					null,
					"name: ",
					React.createElement("input", { type: "text", ref: "name3" })
				),
				React.createElement(
					"p",
					null,
					"message: ",
					React.createElement("textarea", { ref: "text3", placeholder: "enter message" })
				),
				React.createElement(
					"button",
					null,
